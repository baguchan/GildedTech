...
public enum ModArmorMaterial implements ArmorMaterial {
    WROUGHT_NETHERITE("gilded_tech:wrought_netherite", 16, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266654_) -> {
        ...
        return Ingredient.of(ModItems.WROUGHT_NETHERITE_INGOT.get());
    });
